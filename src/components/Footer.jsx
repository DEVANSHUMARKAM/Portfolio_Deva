...
const Footer = ({ scrollRef }) => {
  ...
  return (
    <footer className="bg-[#4831d4] text-white py-10 px-6 md:px-16">
      <div className="flex flex-col md:flex-row justify-between items-center font-bold md:items-start gap-8">
        {/* Quick Links */}
        <div>
          ...
          <ul className="space-y-2">
            {["about", "projects", "education", "skills", "contact"].map((item) => (
              <li key={item}>
                <a
                  href={`#${item}`}
                  className="hover:text-[#9eef47] transition"
                >
        ...
        <div className="text-center md:text-left max-w-md">
          <p className="text-lg italic text-gray-300">
            ...
            that’s what you call a real *Full Stack*."
          </p>
